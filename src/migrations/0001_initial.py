# Generated by Django 5.1.5 on 2025-04-15 02:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('declared_major_code', models.CharField(blank=True, max_length=20, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('major', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='src.majormapping')),
            ],
        ),
        migrations.CreateModel(
            name='StudentAudit',
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['student'], name='src_student_student_7ad857_idx'), models.Index(fields=['term'], name='src_student_term_f5a6d8_idx')],
            },
        ),
    ]
