...
from src.models import (
    MajorMapping, Course, RequirementGroup, RequirementSubgroup, MajorCourse
)
...
# This function is used to import a major from a payload generated by 
def populate_catalog_from_payload(payload):
    ...
    with transaction.atomic():
        ...
        created_subgroups = RequirementSubgroup.objects.bulk_create(subgroup_objs)
        ...
        for mc in payload["major_courses"]:
            ...
            group = group_name_to_obj.get(mc["group_name"]) if mc["subgroup_name"] is None else None
            subgroup = subgroup_map.get((mc["group_name"], mc["subgroup_name"])) if mc["subgroup_name"] else None
